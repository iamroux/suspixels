...
export class MailService {
  ...
  async sendWelcomeEmail(to: string): Promise<void> {
    await this.sendMail(to, 'Welcome to Suspixels! 🎨', welcomeEmailHtml());
  }
  ...
  async sendBulk(
    ...
    const results = await Promise.allSettled(
      emails.map((email) => this.sendMail(email, subject, html)),
    );
...
<head>
  ...
  <title>Welcome to Suspixels</title>
</head>
        ...
        <table role="presentation" width="560" cellspacing="0" cellpadding="0"
          ...
          <tr>
            ...
            <td style="padding:32px 32px 20px;text-align:center;
              ...
              <div style="display:inline-block;margin-bottom:12px;">
                <span style="display:inline-block;width:12px;height:12px;background:#6c63ff;margin:1px;"></span>
                <span style="display:inline-block;width:12px;height:12px;background:#ff6584;margin:1px;"></span>
                <span style="display:inline-block;width:12px;height:12px;background:#43e97b;margin:1px;"></span>
                <span style="display:inline-block;width:12px;height:12px;background:#f7c948;margin:1px;"></span>
                <span style="display:inline-block;width:12px;height:12px;background:#6c63ff;margin:1px;"></span>
              </div>
              ...
              <p style="margin:8px 0 0;font-size:11px;letter-spacing:2px;
          ...
          <tr>
            ...
            <td style="padding:32px;">
              ...
              <table role="presentation" width="100%" cellspacing="0" cellpadding="0">
                <tr>
                  <td style="padding:10px 12px;background-color:#1a1a3a;
                              border-left:3px solid #6c63ff;">
                    <span style="color:#6c63ff;font-size:13px;">&#9632;</span>
                    <span style="font-size:13px;color:#c0c0ee;margin-left:8px;">
                      Place pixels on a shared 3000&times;3000 canvas
                    </span>
                  </td>
                </tr>
                ...
                <tr>
                  <td style="padding:10px 12px;background-color:#1a1a3a;
                    ...
                    <span style="font-size:13px;color:#c0c0ee;margin-left:8px;">
                      See other players paint in real time
                    </span>
                  </td>
                </tr>
                <tr><td style="height:6px;"></td></tr>
                <tr>
                  <td style="padding:10px 12px;background-color:#1a1a3a;
                    ...
                    <span style="font-size:13px;color:#c0c0ee;margin-left:8px;">
                      Save and reuse your favourite colour palettes
                    </span>
                  </td>
                </tr>
              </table>
              ...
              <table role="presentation" cellspacing="0" cellpadding="0"
                     style="margin:0 auto;">
                <tr>
                  <td style="background-color:#6c63ff;
                              box-shadow:4px 4px 0 #3d3799;
                              text-align:center;">
              ...
              <p style="margin:24px 0 0;font-size:11px;color:#5050aa;
          ...
          <tr>
            <td style="padding:16px 32px;text-align:center;
              ...
              <p style="margin:0;font-size:10px;color:#3a3a6a;letter-spacing:1px;">
                You received this because someone signed up with this address.
                &copy; 2025 Suspixels.
              </p>
            </td>
          </tr>
